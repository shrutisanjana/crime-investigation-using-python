...
def mandatory():
    if os.path.isfile('databases/userdetail.dat'):
        ...
        file=open('databases/userdetail.dat',"w")
...
class login:
    def __init__(self,root):
            ...
            #====BG Image====
            image2=Image.open("wp5200183-crime-scene-phone-wallpapers.png")
            ...
            title=Label(Frame_login,text="Login Here",font=("Impact",35,"bold"),fg="#d77337",bg="white").place(x=40,y=30)
    ...
    def Login_function(self):
        ...
        file=open('databases/userdetail.dat',"r")
        data=file.read()
        file.close()
